...
public interface TransistorKeys {
    ...
    /* ACTIONS */
    String ACTION_PLAY = "com.mjhram.radioalarm.action.PLAY";
    String ACTION_STOP = "com.mjhram.radioalarm.action.STOP";
    String ACTION_DISMISS = "com.mjhram.radioalarm.action.DISMISS";
    String ACTION_PLAYBACK_STATE_CHANGED = "com.mjhram.radioalarm.action.PLAYBACK_STATE_CHANGED";
    String ACTION_METADATA_CHANGED = "com.mjhram.radioalarm.action.METADATA_CHANGED";
    String ACTION_SHOW_PLAYER = "com.mjhram.radioalarm.action.SHOW_PLAYER";
    String ACTION_TIMER_RUNNING = "com.mjhram.radioalarm.action.TIMER_RUNNING";
    String ACTION_TIMER_START = "com.mjhram.radioalarm.action.TIMER_START";
    String ACTION_TIMER_STOP = "com.mjhram.radioalarm.action.TIMER_STOP";
